...
public class UserRequestCustomHeaderVersioningController {
	...
	@GetMapping(value = "/{id}", headers = "API-VERSION=1") // Chatper 88
	...
	@GetMapping(value = "/{id}", headers = "API-VERSION=2") // Chatper 88
